...
const car3 = {
  ...
  //Optional Chaining:
  console.log(car3.parts.headlight?.price); // output: undefined (safe, no error)
  //Conditional Check:
  if (car3.parts.headlight && car3.parts.headlight.price) {
    console.log(car3.parts.headlight.price);
  } else {
    console.log('Headlight or its price is not defined.');
  }
